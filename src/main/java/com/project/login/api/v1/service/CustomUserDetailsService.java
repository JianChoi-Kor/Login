...
//        GrantedAuthority grantedAuthority = new SimpleGrantedAuthority(users.getAuthorities().toString());
//        return new User(users.getEmail(), users.getPassword(), Collections.singletonList(grantedAuthority));
